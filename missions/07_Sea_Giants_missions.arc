flavour_missions_2_sea = {
	slot = 7
    generic = no
    ai = yes
    has_country_shield = no
    potential = { primary_culture = sea_giant }
	
	well_developed_tribe_mission = {
        icon = nordic_village
        position = 1
        required_missions = { } 
	...
	true_owners_of_roscrea_mission = {
        icon = state_of_sea_elves
        position = 3
        required_missions = { reform_the_tribe_mission } 
	...
	es_conquest_of_yokuda_lr_sea = {
		position = 11
		defines.functions.conquest_yokuda
	}
	
	es_conquest_of_tsakara_lr_sea = {
	...
	es_conquest_of_thousand_lr_sea = {
...
flavour_missions_3_sea = {
	...
	eternal_alliance_mission = {
        ...
        effect = {
            add_country_modifier = {
				name = "es_eternal_alliance"
				duration = 9125
			}
        }
	}
	
	reform_the_tribe_mission = {
        icon = native_tribe_reform
        position = 2
        required_missions = { well_developed_tribe_mission eternal_alliance_mission terror_of_the_seas_mission } 
	...
	colonise_atmora_sea_mission = {
        icon = atmora_colonisation
        position = 4
        required_missions = { true_owners_of_roscrea_mission reform_the_tribe_mission } 
	...
	land_of_ancestors_mission = {
        icon = atmoran_sanctuary
        position = 2
        required_missions = { colonise_atmora_sea_mission uncountable_legions_islands_mission } 
        ...
        effect = {
            add_country_modifier = {
				name = "es_land_of_ancestors"
				duration = -1
			}
        }
	}
	
	es_conquest_of_upper_tsakara_lr_sea = {
	...
	es_conquest_of_islandic_tsakara_lr_sea = {
	...
	es_conquest_of_valenwood_lr_sea = {
	...
	es_conquest_of_vvardenfell_lr_sea = {
...
flavour_missions_4_sea = {
	...
	terror_of_the_seas_mission = {
        ...
        effect = {
            add_country_modifier = {
				name = "es_terror_of_the_seas"
				duration = -1
			}
        }
	}
	
	resume_raids_mission = {
        icon = nordic_ship_2
        position = 2
        required_missions = { terror_of_the_seas_mission } 
        ...
        effect = {
            add_country_modifier = {
				name = "es_resumed_raids"
				duration = -1
			}
        }
	}
	
	discover_northern_islands_mission = {
        icon = northern_expedition
        position = 3
        required_missions = { resume_raids_mission reform_the_tribe_mission } 
	...
	uncountable_legions_islands_mission = {
        icon = sea_giant
        position = 3
        required_missions = { discover_northern_islands_mission } 
        ...
        effect = {
			 add_country_modifier = {
				name = "es_uncountable_legions"
				duration = -1
			}
        }
	}
	
	es_conquest_of_morrowind_lr_sea = {
	...
	es_conquest_of_black_marsh_lr_sea = {
	...
	es_conquest_of_western_cyrodiil_lr_sea = {
	...
	es_conquest_of_eastern_cyrodiil_lr_sea = {
	...
	es_conquest_of_central_cyrodiil_lr_sea = {
